...
function GaugeParams(cvs) {
    ...
    this.rangeSegments = [{ start: 0, end: 500, color: "yellow" },
                          { start: 500, end: 1170, color: "greenyellow" },
                          { start: 1170, end: 1300, color: "red"}];

    //Scale - Text
    this.dialScaleFont = "bold " + getRelVal(cvs, 17) + "px Trebuchet MS";
    this.dialSubScaleFont = "bold " + getRelVal(cvs, 10) + "px Trebuchet MS";    
